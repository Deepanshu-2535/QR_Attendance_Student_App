...
import { teacherDetails } from '../../mocks/mockdata'
    ...
    <SafeAreaView>
      ...
      <View style={styles.container}>
        <View>
          ...
          <Text className="text-muted">{teacherDetails.department}</Text>
        </View>
        <Divider margin={10} />
        <View className="flex-row justify-between">
          <View className="flex-1 justify-between">
            <Text className="font-semibold text-muted">Designation</Text>
            <Text className="text-muted">{teacherDetails.designation}</Text>
          </View>
