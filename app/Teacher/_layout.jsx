...
import {ChartPie, History, House, QrCode, ScanQrCode, UserRound} from "lucide-react-native"
    ...
    return (
        <Tabs screenOptions={{
            ...
            <Tabs.Screen name="qrcode" options={{
                ...
                headerShown: false,
                tabBarIcon: ({ focused }) => (
                    <TabIcon focused={focused} text="Qr Code" icon = {<QrCode size={25}/>} highlighted={<QrCode size={25} color={colors.primary} />} />
                )
            }}/>
